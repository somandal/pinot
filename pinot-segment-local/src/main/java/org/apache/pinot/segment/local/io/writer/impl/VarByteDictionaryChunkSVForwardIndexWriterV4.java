...
/**
 * Class to write out variable length bytes into a single column for dictionary IDs
 *
 *
 * Only sequential writes are supported.
 */
@NotThreadSafe
public class VarByteDictionaryChunkSVForwardIndexWriterV4 implements VarByteChunkWriter {
  ...
  public VarByteDictionaryChunkSVForwardIndexWriterV4(File file, ChunkCompressionType compressionType, int chunkSize)
      throws IOException {
