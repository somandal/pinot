...
/**
 * Class to write out variable length bytes into a single column. Meant to be used to store raw Dictionary IDs for
 * MV columns
 *
 ...
 */
@NotThreadSafe
public class VarByteDictionaryChunkSVForwardIndexWriter extends BaseChunkSVForwardIndexWriter
   ...
   * @param lengthOfLongestEntry Size of entry (in bytes), max size for variable byte implementation.
   * @param writerVersion version of File
   * @throws IOException if the file isn't found or can't be mapped
   */
  public VarByteDictionaryChunkSVForwardIndexWriter(File file, ChunkCompressionType compressionType, int totalDocs,
  ...
  public void putBigDecimal(BigDecimal value) {
    throw new UnsupportedOperationException("Storing big decimal is not supported!");
  }

  @Override
  public void putString(String value) {
    throw new UnsupportedOperationException("Storing strings is not supported!");
  }
