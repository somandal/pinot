 ...
 * KURTOSIS(*) transforms into: FOURTHMOMENT(*)_SERVER --> FOURTHMOMENT(*)_INTERMEDIATE --> KURTOSIS(*)_FINAL, where
 *   FOURTHMOMENT(*)_SERVER produces TUPLE[ FOURTHMOMENT(data) object, GROUP_BY_KEY ]
 *   FOURTHMOMENT(*)_INTERMEDIATE produces TUPLE[ FOURTHMOMENT(FOURTHMOMENT(*)_SERVER), GROUP_BY_KEY ] (input - object)
 *   KURTOSIS(*)_FINAL produces the final TUPLE[ KURTOSIS(FOURTHMOMENT(*)_INTERMEDIATE), GROUP_BY_KEY ]
 *
...
public class PinotAggregateExchangeNodeInsertRule extends RelOptRule {
  ...
  /**
   * Split the AGG into 3 plan fragments, all with the same AGG type,
