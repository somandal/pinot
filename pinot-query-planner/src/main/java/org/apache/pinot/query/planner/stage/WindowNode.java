...
public class WindowNode extends AbstractStageNode {
  ...
  private List<RexLiteral> _constants;
  ...
  public WindowNode(int stageId, List<Window.Group> windowGroups, List<RexLiteral> constants, DataSchema dataSchema) {
    ...
    // TODO: Modify this to store a single window group. The parser should always break multiple window groups into
    //       multiple logical windows as each window might need exchanges and need to be handled differently.
    ...
    // TODO: Constants may be needed for the frame literals, figure out the best way to store them when frame support
    //       is added.
  ...
  public static class PinotWindow {
    ...
    public PinotWindow(ImmutableBitSet keys, RelCollation orderKeys, ImmutableList<Window.RexWinAggCall> winAggCalls,
      ...
      // TODO: Support isPreceding, isFollowing, isUnbounded. For now only support default frame. Add checks for default
      //       frame values.
