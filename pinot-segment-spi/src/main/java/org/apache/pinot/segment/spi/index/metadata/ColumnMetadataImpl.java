...
public class ColumnMetadataImpl implements ColumnMetadata {
  ...
  private boolean _hasDictionaryWithCompression;
  ...
  public boolean equals(Object o) {
    ...
    return _totalDocs == that._totalDocs && _cardinality == that._cardinality && _sorted == that._sorted
        ...
        .equals(_partitions, that._partitions) && _hasDictionaryWithCompression == that._hasDictionaryWithCompression;
  }
  ...
  public int hashCode() {
    return Objects
        .hash(_fieldSpec, _totalDocs, _cardinality, _sorted, _minValue, _maxValue, _hasDictionary, _columnMaxLength,
            ...
            _partitions, _autoGenerated, _hasDictionaryWithCompression);
  }
  ...
  public String toString() {
    return "ColumnMetadataImpl{" + "_fieldSpec=" + _fieldSpec + ", _totalDocs=" + _totalDocs + ", _cardinality="
        ...
        + ", _hasDictionaryWithCompression=" + _hasDictionaryWithCompression + '}';
  }
  ...
  public static ColumnMetadataImpl fromPropertiesConfiguration(String column, PropertiesConfiguration config) {
    Builder builder = new Builder().setTotalDocs(config.getInt(Column.getKeyFor(column, Column.TOTAL_DOCS)))
        ...
        .setHasDictionaryWithCompression(config.getBoolean(Column.getKeyFor(column,
            Column.HAS_DICTIONARY_WITH_COMPRESSION), false));
  ...
  public static class Builder {
    ...
    public Builder setHasDictionaryWithCompression(boolean hasDictionaryWithCompression) {
      _hasDictionaryWithCompression = hasDictionaryWithCompression;
      return this;
    }
    ...
    public ColumnMetadataImpl build() {
      return new ColumnMetadataImpl(_fieldSpec, _totalDocs, _cardinality, _sorted, _minValue, _maxValue, _hasDictionary,
          ...
          _partitionFunction, _partitions, _autoGenerated, _hasDictionaryWithCompression);
    }
  }
}
