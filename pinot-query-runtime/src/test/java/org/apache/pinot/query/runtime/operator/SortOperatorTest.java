...
public class SortOperatorTest {
  ...
  public void shouldHandleUpstreamErrorBlock() {
    ...
    SortOperator op = new SortOperator(_input, collation, directions, 10, 0, schema, 1, 2, _serverAddress, false);
  ...
  public void shouldConsumeAndSkipSortInputOneBlockWithTwoRowsInputSorted() {
    ...
    List<Direction> directions = ImmutableList.of(Direction.ASCENDING);
    DataSchema schema = new DataSchema(new String[]{"sort"}, new DataSchema.ColumnDataType[]{INT});
    SortOperator op = new SortOperator(_input, collation, directions, 10, 0, schema, 1, 2, _serverAddress, true);
  ...
  public void shouldOffsetSortInputOneBlockWithThreeRows() {
    ...
    List<Direction> directions = ImmutableList.of(Direction.ASCENDING);
    DataSchema schema = new DataSchema(new String[]{"sort"}, new DataSchema.ColumnDataType[]{INT});
    SortOperator op = new SortOperator(_input, collation, directions, 10, 1, schema, 1, 2, _serverAddress, false);
  ...
  public void shouldOffsetSortInputOneBlockWithThreeRowsInputSorted() {
    ...
    List<Direction> directions = ImmutableList.of(Direction.ASCENDING);
    DataSchema schema = new DataSchema(new String[]{"sort"}, new DataSchema.ColumnDataType[]{INT});
    SortOperator op = new SortOperator(_input, collation, directions, 10, 1, schema, 1, 2, _serverAddress, true);
  ...
  public void shouldOffsetLimitSortInputOneBlockWithThreeRows() {
    ...
    List<Direction> directions = ImmutableList.of(Direction.ASCENDING);
    DataSchema schema = new DataSchema(new String[]{"sort"}, new DataSchema.ColumnDataType[]{INT});
    SortOperator op = new SortOperator(_input, collation, directions, 1, 1, schema, 1, 2, _serverAddress, false);
  ...
  public void shouldOffsetLimitSortInputOneBlockWithThreeRowsInputSorted() {
    ...
    List<Direction> directions = ImmutableList.of(Direction.ASCENDING);
    DataSchema schema = new DataSchema(new String[]{"sort"}, new DataSchema.ColumnDataType[]{INT});
    SortOperator op = new SortOperator(_input, collation, directions, 1, 1, schema, 1, 2, _serverAddress, true);
  ...
  public void shouldRespectDefaultLimit() {
    ...
    List<Direction> directions = ImmutableList.of(Direction.ASCENDING);
    DataSchema schema = new DataSchema(new String[]{"sort"}, new DataSchema.ColumnDataType[]{INT});
    SortOperator op = new SortOperator(_input, collation, directions, 0, 0, schema, 1, 1, 2, _serverAddress, false);
  ...
  public void shouldFetchAllWithNegativeFetch() {
    ...
    List<Direction> directions = ImmutableList.of(Direction.ASCENDING);
    DataSchema schema = new DataSchema(new String[]{"sort"}, new DataSchema.ColumnDataType[]{INT});
    SortOperator op = new SortOperator(_input, collation, directions, -1, 0, schema, 1, 2, _serverAddress, false);
