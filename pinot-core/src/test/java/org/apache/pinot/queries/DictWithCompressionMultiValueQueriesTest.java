...
/**
 * The <code>DictWithCompressionMultiValueQueriesTest</code> class sets up the index segment for the multi-value
 * queries test.
 ...
 *   HasDictionaryWithCompression: S1, S2
 ...
 *   <li>column6, DIMENSION, INT, 18499, F, F, T, T, T</li>
 ...
 * </ul>
 */
public class DictWithCompressionMultiValueQueriesTest extends BaseQueriesTest {
  private static final String AVRO_DATA = "data" + File.separator + "test_data-mv.avro";
  private static final String SEGMENT_NAME_1 = "testTable_1756015683_1756015683";
  private static final String SEGMENT_NAME_2 = "testTable_1756015683_1756015684";
  private static final File INDEX_DIR = new File(FileUtils.getTempDirectory(),
      "DictWithCompressionMultiValueQueriesTest");
  ...
  // Contains 2 index segments, one with 2 MV columns with dictionary with compression enabled, and the other with
  // just 1.
  ...
  private void createSegment(String filePath, String segmentName, Schema schema)
    ...
    if (segmentName.equals(SEGMENT_NAME_1)) {
      fieldConfigList.add(new FieldConfig("column7", FieldConfig.EncodingType.RAWDICTIONARY,
    ...
    if (segmentName.equals(SEGMENT_NAME_1)) {
      dictionaryWithCompressionColumnMap.put("column7", ChunkCompressionType.SNAPPY);
    }
  ...
  private ImmutableSegment loadSegmentWithMetadataChecks(String segmentName)
    ...
    columnMetadataMap1.forEach((column, metadata) -> {
      ...
      } else if (segmentName.equals(SEGMENT_NAME_1) && column.equals("column7")) {
        assertTrue(metadata.hasDictionary());
        assertTrue(metadata.hasDictionaryWithCompression());
      } else {
